...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                <div className="absolute z-[1] inset-y-0 left-0 pl-3 flex items-center justify-center pointer-events-none">
      ...
      <AuthImagePattern
        title="Join us today"
        subtitle="Create an account and start exploring our platform"
      />
    </div>
  );
};
